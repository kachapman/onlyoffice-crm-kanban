...
**Current version:** 1.6.0 — see [CHANGELOG.md](./CHANGELOG.md), [docs/RELEASE_v1.6.md](./docs/RELEASE_v1.6.md), and server deploy [docs/UPDATE_AND_DEPLOY.txt](./docs/UPDATE_AND_DEPLOY.txt).
