...
**Current version:** 1.4.0 — see [CHANGELOG.md](./CHANGELOG.md), [docs/RELEASE_v1.4.md](./docs/RELEASE_v1.4.md), and server deploy [docs/UPDATE_AND_DEPLOY.txt](./docs/UPDATE_AND_DEPLOY.txt).
