...
**Current version:** 1.4.5 — see [CHANGELOG.md](./CHANGELOG.md), [docs/RELEASE_v1.4.5.md](./docs/RELEASE_v1.4.5.md), and server deploy [docs/UPDATE_AND_DEPLOY.txt](./docs/UPDATE_AND_DEPLOY.txt).
