...
- **Local kanban horizontal scrollbar chin hidden.** `.local-kanban-tile .board` gets `overflow-x: hidden` to prevent the horizontal scrollbar track from creating visible empty space at the bottom of the tile.
