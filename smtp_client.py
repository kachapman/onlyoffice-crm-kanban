"""SMTP client for Vanguard CRM v3.0 — password reset emails (MVP)."""
...
def send_password_reset_email(to_addr: str, reset_url: str) -> bool:
    ...
    subject = "Vanguard CRM — Password Reset"
    html_body = f"""
    <html>
    <body style="font-family: sans-serif; color: #333;">
        <h2>Password Reset</h2>
        <p>You requested a password reset for your Vanguard CRM account.</p>
